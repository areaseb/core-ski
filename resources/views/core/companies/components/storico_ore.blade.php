									...
									<div class="card-body">
										<table class="table table-sm table-bordered table-striped table-php">
				                            ...
				                            <tbody>
				                                ...
				                                @foreach(\Areaseb\Core\Http\Controllers\CompanyController::getStoricoOreCliente($company->id)[0]->sortBy([['data', 'asc'],['ora_in', 'asc']]) as $dd)
									...
									<div class="card-body">
										<table class="table table-sm table-bordered table-striped table-php">
				                            ...
				                            <tbody>
				                                ...
				                                @foreach(\Areaseb\Core\Http\Controllers\CompanyController::getStoricoOreCliente($company->id)[1]->sortBy([['data', 'asc'],['ora_in', 'asc']]) as $dd)
				                                <tr>
