        ...
        <div class="card-body pb-0">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Privato</label>
                        {!!Form::select('private', [1 => 'Si', 0 => 'No'], null, ['class' => 'custom-select', 'id' => 'privato'])!!}
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label>SDI</label>
                        {!!Form::text('sdi', null, ['class' => 'form-control', 'id' => 'sdi', 'placeholder' => 'Identificativo e-fattura', 'maxlength' => '7'])!!}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
        ...
        <div class="card-body pb-0">
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        <label>Sedi</label>
                        {!! Form::select('branch_id[]',$branches, null, ['class' => 'select2 ucc', 'data-placeholder' => 'Associa uno o più sedi', 'data-fouc', 'multiple' => 'multiple','style' => 'width:100%']) !!}
                    </div>
                </div>
