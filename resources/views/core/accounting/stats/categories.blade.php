...
@include('areaseb::layouts.elements.title', ['title' => 'Statistiche Categorie Prodotti'])
                        ...
                        <div class="row">
	                        ...
	                        <div class="col-md-3">    
	                            ...
	                            @if(request()->get('data_in') || request()->get('data_out'))
	                            	<a href="@if(date('m') >= 6) {{url('stats/categorie?year='.date('Y'))}} @else {{url('stats/categorie?year='.(date('Y')-1))}} @endif"><button type="submit" class="btn btn-secondary btn-lg" id="submitForm"><i class="fa fa-redo"></i></button></a>
	                            @endif
	                        </div>
                        </div>
                    </div>
        ...
        @foreach($data as $cat => $values)
            <div class="col-6 col-md-3">
                <div class="small-box bg-info">
                    <div class="inner">
                        <h6 class="mb-0">{{Areaseb\Core\Models\Category::find($cat)->nome}}</h6>
