@php
    ...
    $branches_company = [];
    if($company != null){
        $branches_list = $company->branches()->get();
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        {!!Form::select('tipo_socio', [2 => 'Socio professionale', 1 => 'Socio partner', 3 => 'Socio aspirante', 4 => 'Non socio'], null, ['class' => 'custom-select', 'id' => 'tipo_socio'])!!}                       
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!!Form::select('disciplina', [ 1 => 'Discesa', 2 => 'Fondo', 4 => 'Snowboard'], null, ['class' => 'custom-select', 'id' => 'disciplina'])!!}                       
        ...
        <div class="card card-outline card-danger pad-tab">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group">
                        <label>Sede</label>
                        {!! Form::select('branch_id',$branches_company, $user_branch, ['class' => 'custom-select', 'data-placeholder' => 'Associa una sede', 'id' => 'branch_id','style' => 'width:100%']) !!}
                    </div>
                </div>
...
<script>
    ...
    var contact_branch = <?php echo isset($contact) && $contact->branch($contact->id) != null ? json_encode($contact->branch($contact->id)) : "null"; ?>;
    ...
    console.log(contact_specializations);
    //console.log(contact_branch[0]);
    $( document ).ready(function() {
        ...
        if(contact_branch != null){
            $('#branch_id').val(contact_branch[0]);
        }
