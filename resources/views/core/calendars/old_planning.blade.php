            ...
            <div class="card">
                <div class="card-body">
                    <form action="/planning" method="GET">
                        <b>Giorno:</b> <input type="date" name="giorno" size="10" maxlength="10" value="{{$a}}-{{$m}}-{{$g}}">
                        <input type="submit" value="Filtra" class="no">
                    </form>
                </div>
                <br>
                ...
                <table width="97%" cellpadding="3" cellspacing="0" border="0" align="center" class="tabelle">
                    <tbody>
                        <tr>
                            <td colspan="22" class="intestazione" align="center">
                            ...
                            @php
                                    ...
                                    if($ora_out != '')
                                    {
                                        ...
                                        if(substr($id_cliente, 0, 1) == "C"){
                                                ...
                                                $nome_cliente = "<div class=\"cella_cal\" style=\"position: absolute; padding: 4px; margin: -3px -3px -3px -5px; border-left: solid 2px #0082DA; background-color: $colore_maestro; width: ".$width."%; height: 49px; z-index: 10;\">
                                                                                            <a href=\"/collective/$id_collettivo\" style=\"color: #000066; font-size: 12px;\" title=\"Modifica collettivo\">Collettivo ".$collettivo->nome." $allievi_c </a> $bambino $ritrovo $dollaro $telefono $aperta";
                                        ...
                                        elseif($id_cliente != "") {
                                                    ...
                                                    if($contact != null){
                                                        ...
                                                        if($elem != null && $elem->saldato == 0){
                                                            ...
                                                            $nome_cliente = "<div class=\"cella_cal\" style=\"position: absolute; padding: 4px; margin: -3px -3px -3px -5px; border-left: solid 2px #0082DA; background-color: $colore_maestro; width: ".$width."%; z-index: 10;\">
                                                                            <a href=\"#\" onClick=\"openModOra($id_ora)\" title=\"Modifica ora\" style=\"color: #000066; font-size: 12px;\"><b>$nome_cli</b></a> $cliente_disabile $bambino $ritrovo $cf $dollaro $telefono $aperta <a href=\"/$link_fattura\" title=\"Anteprima fattura\"><img src=\"$img_attenzione\" align=\"center\" border=\"0\" width=\"15\" width=\"15\"></a><br>
                                                                                                    <a href=\"tel:$ntelefono\" style=\"color: #000066; font-size: 12px;\">$ntelefono</a>";
                                                            $tot_ore = $tot_ore + $diff;
                                                        } elseif($elem != null && $elem->saldato == 1){
                                                            $nome_cliente = "<div class=\"cella_cal\" style=\"position: absolute; padding: 4px; margin: -3px -3px -3px -5px; border-left: solid 2px #0082DA; background-color: $colore_maestro; width: ".$width."%; z-index: 10;\">
                                                                            <a href=\"#\" onClick=\"openModOra($id_ora)\" title=\"Modifica ora\" style=\"color: #000066; font-size: 12px;\">$nome_cli</a> $cliente_disabile $bambino $ritrovo $cf $dollaro $telefono $aperta<br>
                                                                                                    <a href=\"tel:$ntelefono\" style=\"color: #000066; font-size: 12px;\">$ntelefono</a>";
                                                            $tot_ore = $tot_ore + $diff;
                                                        } 
                                                ...
                                                if($tipo == 'Y'){
                                                    ...
                                                    if($contact != null){
                                                        ...
                                                        if($elem != null && $elem->saldato == 0){
                                                            $link_fattura = 'invoices/'.$elem->id.'/edit';
                                                            $nome_cliente = "<div class=\"cella_cal\" style=\"position: absolute; padding: 4px; margin: -3px -3px -3px -5px; border-left: solid 2px #0082DA; background-color: $colore_maestro; width: ".$width."%; z-index: 10;\">
                                                                            <a href=\"#\" onClick=\"openModOra($id_ora)\" title=\"Modifica ora\" style=\"color: #000066; font-size: 12px;\"><b>$nome_cli</b></a> $cliente_disabile $bambino $ritrovo $cf $dollaro $telefono $aperta <a href=\"/$link_fattura\" title=\"Anteprima fattura\"><img src=\"$img_attenzione\" align=\"center\" border=\"0\" width=\"15\"></a><br>
                                                                                                    <a href=\"tel:$ntelefono\" style=\"color: #000066; font-size: 12px;\">$ntelefono</a>";
                                                            $tot_ore = $tot_ore + $diff;
                                                        } elseif($elem != null && $elem->saldato == 1){
                                                            $nome_cliente = "<div class=\"cella_cal\" style=\"position: absolute; padding: 4px; margin: -3px -3px -3px -5px; border-left: solid 2px #0082DA; background-color: $colore_maestro; width: ".$width."%; z-index: 10;\">
                                                ...
                                                if($tipo == 'L')
                                                {
                                                    ...
                                                    <a href=\"#\" onClick=\"openModOra($id_ora)\" title=\"Modifica ora\" style=\"color: white; font-size: 12px;\"><b>$nome_cli</b></a><br><br>";
                                    ...
                                    if($ora_in != ""){
                                        if($nome_cliente == ""){
                                            ...
                                            $nome_cliente = "<a href=\"#\" onClick=\"openAddOraPreimpostata($ora[0],$ora[1],$id_maestro,$id_sede)\"  title=\"Aggiungi ora\" style=\"color: #000066; font-size: 12px;\"><i align=\"top\" class=\"fa fa-plus plus-icon-tab text-success\"></i></a>";
                                            $align = "center";
                                        } else {
                                            $align = "left";
                                        }
