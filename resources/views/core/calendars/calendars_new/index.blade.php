...
@include('areaseb::layouts.elements.title', ['title' => 'Calendari'])
                        ...
                        <tbody>
                            @foreach($calendars as $calendar)
                                <tr id="row-{{$calendar->id}}" data-model="{{$calendar->class}}" data-id="{{$calendar->id}}">
                                    <td class="editable" data-field="nome">{{$calendar->nome}} @if($calendar->user->contact) {{$calendar->user->contact->fullname}} @else {{$calendar->user->email}} @endif</td>
