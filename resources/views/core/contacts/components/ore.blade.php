                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered table-striped table-php">
                            ...
                            <tbody>
                                ...
                                @foreach(\Areaseb\Core\Http\Controllers\ContactController::getOreAperteCliente($contact->id)->sortBy([['data', 'asc'],['ora_in', 'asc']]) as $dd)
                                	...
                                	@php	                               
										...
										$client_invoices = \Areaseb\Core\Models\Invoice::where('contact_id', $contact->id)->pluck('id')->toArray();
	                                ...
	                                <tr>
										...
										<td>
											@if($invoice_id)
		                                        <a href="/invoices/{{$dd->id}}" class="btn btn-primary btn-icon btn-sm"><i class="fa fa-eye"></i></a>
		                                        <a href="/invoices/{{$dd->id}}/edit" class="btn btn-warning btn-icon btn-sm"><i class="fa fa-edit"></i></a>
		                                    @endif
